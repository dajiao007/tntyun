...
* **获取软件：** 请前往 Clash Verge 下载对应您系统的 v2.7.4 安装包。
...
1. **获取订阅链接（购买服务）：** 在 [TNTCloud 官网](https://tntyun.cc/#/register?code=CZVdpQnI)选择套餐进行订阅，在用户后台首页找到“一键订阅”或“导入到 Clash”按钮，点击**复制 Clash 订阅链接**。
2. **导入到 Clash Verge：**
   * 打开 Clash Verge 客户端。

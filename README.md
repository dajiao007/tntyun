<div align="center">
  ...
  <p>
    👉 <strong>TNTCloud 官网入口：</strong> <a href="https://tntyun.cc/#/register?code=CZVdpQnI">TNTCloud 官网</a>
  </p>
</div>
...
| 平台 | 客户端 |
| :--- | :--- |
| 桌面端主力推荐（本指南重点） | **Clash Verge**。它界面美观、功能强大，支持 Windows、macOS 和 Linux 平台。 |
...
* **获取软件：** 请前往 Clash Verge 下载对应您系统的安装包。
* **安装：** 按提示“下一步”完成安装即可。首次打开可能会有防火墙提示，请务必选择**允许访问**。
...
1. **获取订阅链接（购买服务）：** 
   ...
   * 在 [TNTCloud 官网](https://tntyun.cc/#/register?code=CZVdpQnI)选择套餐进行订阅，在用户后台首页找到“一键订阅”或“导入到 Clash”按钮，点击**复制 Clash 订阅链接**。
2. **导入到 Clash Verge：**
   * 打开 Clash Verge 客户端。
...
<div align="center">
  👉 <strong>TNTCloud 官方入口：</strong> <a href="https://tntyun.cc/#/register?code=CZVdpQnI">TNTCloud 官网</a>
</div>
